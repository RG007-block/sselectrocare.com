...
jQuery( document ).ready(function() {
    ...
    jQuery(".skin-1").on('click', function(){
		...
		jQuery(".about-electric-one-media img").attr("src", "images/about-electric/d-1-1.png");
		jQuery(".how-it-electric-media2 img").attr("src", "images/how-it-work/d-1-1.png");			
		...
		jQuery(".animated-right-electric-media img").attr("src", "images/d2-testimonial-1.png");			
		
		jQuery(".home-1-change-img-slide1 img").attr("src", "images/main-slider/slider1/electric/d-1-1.png");
    ...
    jQuery(".skin-2").on('click', function(){
		...
		jQuery(".about-electric-one-media img").attr("src", "images/about-electric/d-1-2.png");	
		jQuery(".how-it-electric-media2 img").attr("src", "images/how-it-work/d-1-2.png");	
		
		jQuery(".animated-right-electric-media img").attr("src", "images/d2-testimonial-2.png");	
		...
		jQuery(".home-1-change-img-slide1 img").attr("src", "images/main-slider/slider1/electric/d-1-2.png");
    ...
    jQuery(".skin-3").on('click', function(){
		...
		jQuery(".about-electric-one-media img").attr("src", "images/about-electric/d-1-3.png");	
		jQuery(".how-it-electric-media2 img").attr("src", "images/how-it-work/d-1-3.png");	
		
		jQuery(".animated-right-electric-media img").attr("src", "images/d2-testimonial-3.png");					
		...
		jQuery(".home-1-change-img-slide1 img").attr("src", "images/main-slider/slider1/electric/d-1-3.png");
    ...
    jQuery(".skin-4").on('click', function(){
		...
		jQuery(".about-electric-one-media img").attr("src", "images/about-electric/d-1-4.png");	
		jQuery(".how-it-electric-media2 img").attr("src", "images/how-it-work/d-1-4.png");	
		
		jQuery(".animated-right-electric-media img").attr("src", "images/d2-testimonial-4.png");						
		...
		jQuery(".home-1-change-img-slide1 img").attr("src", "images/main-slider/slider1/electric/d-1-4.png");
    ...
    jQuery(".skin-5").on('click', function(){
		...
		jQuery(".about-electric-one-media img").attr("src", "images/about-electric/d-1-5.png");	
		jQuery(".how-it-electric-media2 img").attr("src", "images/how-it-work/d-1-5.png");	
		
		jQuery(".animated-right-electric-media img").attr("src", "images/d2-testimonial-5.png");					
		...
		jQuery(".home-1-change-img-slide1 img").attr("src", "images/main-slider/slider1/electric/d-1-5.png");
    ...
    jQuery(".skin-6").on('click', function(){
		...
		jQuery(".about-electric-one-media img").attr("src", "images/about-electric/d-1-6.png");
		jQuery(".how-it-electric-media2 img").attr("src", "images/how-it-work/d-1-6.png");	
		
		jQuery(".animated-right-electric-media img").attr("src", "images/d2-testimonial-6.png");							
		...
		jQuery(".home-1-change-img-slide1 img").attr("src", "images/main-slider/slider1/electric/d-1-6.png");
    ...
    jQuery(".skin-7").on('click', function(){
		...
		jQuery(".about-electric-one-media img").attr("src", "images/about-electric/d-1-7.png");
		jQuery(".how-it-electric-media2 img").attr("src", "images/how-it-work/d-1-7.png");		
		
		jQuery(".animated-right-electric-media img").attr("src", "images/d2-testimonial-7.png");					
		...
		jQuery(".home-1-change-img-slide1 img").attr("src", "images/main-slider/slider1/electric/d-1-7.png");
    ...
    jQuery(".skin-8").on('click', function(){
		...
		jQuery(".about-electric-one-media img").attr("src", "images/about-electric/d-1-8.png");	
		jQuery(".how-it-electric-media2 img").attr("src", "images/how-it-work/d-1-8.png");	
		
		jQuery(".animated-right-electric-media img").attr("src", "images/d2-testimonial-8.png");					
		...
		jQuery(".home-1-change-img-slide1 img").attr("src", "images/main-slider/slider1/electric/d-1-8.png");
    ...
    jQuery(".skin-9").on('click', function(){
		...
		jQuery(".about-electric-one-media img").attr("src", "images/about-electric/d-1-9.png");	
		jQuery(".how-it-electric-media2 img").attr("src", "images/how-it-work/d-1-9.png");	
		
		jQuery(".animated-right-electric-media img").attr("src", "images/d2-testimonial-9.png");					
		...
		jQuery(".home-1-change-img-slide1 img").attr("src", "images/main-slider/slider1/electric/d-1-9.png");
    ...
    jQuery(".skin-10").on('click', function(){
		...
		jQuery(".about-electric-one-media img").attr("src", "images/about-electric/d-1-10.png");
		jQuery(".how-it-electric-media2 img").attr("src", "images/how-it-work/d-1-10.png");	
		
		jQuery(".animated-right-electric-media img").attr("src", "images/d2-testimonial-10.png");					
		...
		jQuery(".home-1-change-img-slide1 img").attr("src", "images/main-slider/slider1/electric/d-1-10.png");
    ...
    jQuery(".skin-11").on('click', function(){
		...
		jQuery(".about-electric-one-media img").attr("src", "images/about-electric/d-1-11.png");
		jQuery(".how-it-electric-media2 img").attr("src", "images/how-it-work/d-1-11.png");	
		
		jQuery(".animated-right-electric-media img").attr("src", "images/d2-testimonial-11.png");					
		...
		jQuery(".home-1-change-img-slide1 img").attr("src", "images/main-slider/slider1/electric/d-1-11.png");
    ...
    jQuery(".skin-12").on('click', function(){
		...
		jQuery(".about-electric-one-media img").attr("src", "images/about-electric/d-1-12.png");
		jQuery(".how-it-electric-media2 img").attr("src", "images/how-it-work/d-1-12.png");	
		
		jQuery(".animated-right-electric-media img").attr("src", "images/d2-testimonial-12.png");					
		...
		jQuery(".home-1-change-img-slide1 img").attr("src", "images/main-slider/slider1/electric/d-1-12.png");
